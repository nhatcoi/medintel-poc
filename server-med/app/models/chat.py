"""Phiên chat + tin nhắn agentic (tool_calls, suggested_actions) cho MedIntel."""
...
class ChatSession(Base, TimestampMixin):
    """Một cuộc hội thoại AI theo profile (nhiều lượt user/assistant)."""
...
class ChatMessage(Base):
    """Một dòng trong lịch sử chat; assistant có thể kèm tool_calls / suggested_actions (JSON)."""
